class Hamburger {
    ...
    get calories() {
        ...
        if (this._stuffing === 'STUFFING_CHEESE') {
            listOfCalories.push(Hamburger.STUFFINGS[Hamburger.STUFFING_CHEESE]['calories']);
        } else if (this._stuffing === 'STUFFING_SALAD') {
            listOfCalories.push(Hamburger.STUFFINGS[Hamburger.STUFFING_SALAD]['calories']);
        } else if (this._stuffing === 'STUFFING_MEAT') {
            listOfCalories.push(Hamburger.STUFFINGS[Hamburger.STUFFING_MEAT]['calories']);
        };
        if (this._toppings.includes('TOPPING_SPICE')) {
            listOfCalories.push(Hamburger.TOPPINGS[Hamburger.TOPPING_SPICE]['calories']);
        }
        if (this._toppings.includes('TOPPING_SAUCE')) {
            listOfCalories.push(Hamburger.TOPPINGS[Hamburger.TOPPING_SAUCE]['calories']);
        };
